...
--[[
	Do edit anything under this. um i edited it lol >:) #skidded lol
]]

wait(0.5)
game.StarterGui:SetCore("SendNotification", {
Title = "yur mum"; -- the title (ofc)
Text = "thanks i can skid this now lol :!("; -- what the text says (ofc)
...
local FOV_CIRCLE = Drawing.new("Polygon")
FOV_CIRCLE.Visible = true
FOV_CIRCLE.Filled = false
FOV_CIRCLE.Thickness = 1
FOV_CIRCLE.Transparency = 0.5
FOV_CIRCLE.Color = Color3.new(51, 184, 245)
